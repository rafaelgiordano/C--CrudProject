...
void Sinistro::salvarArquivoSinistro()
{
	ofstream file;

	file.open("data.txt", ios::app);

	file << "Data: " << dateSinistro.getDiaData() << "." << dateSinistro.getMesData() << "." << dateSinistro.getAnoData() << "\n\n";
	...
	file << "Terceiro" << "\n";
	file << "Seguradora: " << terceiro->getSeguradoraTerceiro() << "\n";
	file << "Nome: " << terceiro->getNomeTerceiro() << "\n";
	file << "Telefone: " << terceiro->getTelefoneTerceiro()  << "\n";
	file << "CPF: " << terceiro->getCPFTerceiro() << "\n";
	file << "Endereço: " << terceiro->getEnderecoTerceiro() << "\n";
	file << "Idade: " << terceiro->getIdadeTerceiro() << "\n\n";
