...
void Apolice::salvarArquivoApolice()
{
	ofstream file;

	file.open("data.txt", ios::app);

	file << "Data de vigência: " << vigencia.getDiaData() << "." << vigencia.getMesData() << "." << vigencia.getAnoData() << "\n\n";
	file << "Veículo" << "\n";
	file << "Ano: " << veiculo->getAnoVeiculo() << "\n";
	file << "Placa: " << veiculo->getPlacaVeiculo() << "\n";
	file << "Renavam: " << veiculo->getRenavamVeiculo() << "\n";
	file << "Tipo veículo: ";
...
void Apolice::salvarArquivoOrcamentoApolice()
{
	ofstream file;
	...
	{
		file << "Orçamento #" << i + 1 << "\n";
		file << "Tipo: " << orcamento[i]->getTipoOrcamento() << "\n";
		file << "Valor de ressarcimento: " << orcamento[i]->getValorRessarcOrcamento() << "\n\n";
	}
...
void Apolice::salvarArquivoSinistroApolice()
{
	ofstream file;
	...
	for (int i = 0; i < getQtdeSinistro(); i++)
	{
		...
		file << "Sinistro #" << i + 1 << "\n";
		file << "Número: " << sinistro[i]->getNumSinistro() << "\n";
		file << "Local: " << sinistro[i]->getLocalSinistro() << "\n";
		...
		file.close();
		sinistro[i]->salvarArquivoSinistro();
	}
}